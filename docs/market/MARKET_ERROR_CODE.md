...
8. Member-Point results[] 기준으로 성공/실패 반영
9. 성공한 Prediction은 SETTLED
10. 실패한 Prediction은 재시도 대상으로 기록
11. 모든 지급 성공 시 MarketStatus = SETTLED
12. 일부 실패 시 MarketStatus = SETTLEMENT_IN_PROGRESS 유지
```
