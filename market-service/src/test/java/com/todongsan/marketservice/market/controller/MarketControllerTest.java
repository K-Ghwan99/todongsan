...
class MarketControllerTest {
    ...
    void getMarketsReturnsPagedSummaryWithoutDetailOnlyPoolFields() throws Exception {
        mockMvc.perform(get("/api/v1/markets")
                ...
                .andExpect(jsonPath("$.data.content[0].regionScope").value("NON_REGIONAL"))
                .andExpect(jsonPath("$.data.content[0].regionSido").isEmpty())
                .andExpect(jsonPath("$.data.content[0].regionSigu").isEmpty())
