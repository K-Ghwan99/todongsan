...
class MarketOpenApiDocsTest {
    ...
    void openApiDocsExposeCurrentMarketApis() throws Exception {
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/markets/{marketId}/comments'].post").exists())
                .andExpect(jsonPath("$.paths['/api/v1/markets/{marketId}/comments'].get").exists())
                .andExpect(jsonPath("$.paths['/api/v1/markets/{marketId}/comments/{commentId}'].delete").exists())
                ...
                .andExpect(jsonPath("$.paths['/internal/api/v1/markets/{marketId}/basic-info']").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/admin/markets'].post.requestBody.content['application/json'].schema['$ref']")
                        .value("#/components/schemas/CreateMarketRequest"))
                .andExpect(jsonPath("$.components.schemas.CreateMarketRequest.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.CreateMarketRequest.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.CreateMarketRequest.properties.regionSigu").exists())
                .andExpect(jsonPath("$.components.schemas.CreateMarketResponse.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.CreateMarketResponse.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.CreateMarketResponse.properties.regionSigu").exists())
                ...
                .andExpect(jsonPath("$.paths['/api/v1/markets/{marketId}/comments'].post.parameters[*].name")
                        .value(hasItem("X-Member-Id")))
                .andExpect(jsonPath("$.paths['/api/v1/markets/{marketId}/comments/{commentId}'].delete.parameters[*].name")
                        .value(hasItem("X-Member-Id")))
                .andExpect(jsonPath("$.paths['/internal/api/v1/markets/{marketId}/basic-info'].get.parameters[*].name")
                        .value(hasItem("X-Internal-Auth")))
                .andExpect(jsonPath("$.paths['/internal/api/v1/markets/{marketId}/basic-info'].get.parameters[*].in")
                        .value(hasItem("header")))
                ...
                .andExpect(jsonPath("$.components.schemas.MarketCommentPageResponse.properties.page").exists())
                .andExpect(jsonPath("$.components.schemas.MarketCommentPageResponse.properties.number").doesNotExist())
                .andExpect(jsonPath("$.components.schemas.MarketCommentPageResponse.properties.first").doesNotExist())
                .andExpect(jsonPath("$.components.schemas.MarketSummary.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.MarketSummary.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.MarketSummary.properties.regionSigu").exists())
                .andExpect(jsonPath("$.components.schemas.MarketDetailResponse.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.MarketDetailResponse.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.MarketDetailResponse.properties.regionSigu").exists())
                .andExpect(jsonPath("$.components.schemas.AdminMarketDetailResponse.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.AdminMarketDetailResponse.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.AdminMarketDetailResponse.properties.regionSigu").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.marketId").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.title").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.optionLabels").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.regionScope").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.regionSido").exists())
                .andExpect(jsonPath("$.components.schemas.MarketBasicInfoResponse.properties.regionSigu").exists())
